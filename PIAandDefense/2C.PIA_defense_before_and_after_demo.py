...
if __name__ == '__main__':
    ...
    log_path_dict = {}
    log_path_dict[1] = "PIA_output/2C_defense_beforeandafter_1_eat_glass"
    log_path_dict[2] = "PIA_output/2C_defense_beforeandafter_2_flat_earth"
    log_path_dict[3] = "PIA_output/2C_defense_beforeandafter_3_virus"
    log_path_dict[4] = "PIA_output/2C_defense_beforeandafter_4_evolution"
    log_path_dict[5] = "PIA_output/2C_defense_beforeandafter_5_Bill_Gates"
