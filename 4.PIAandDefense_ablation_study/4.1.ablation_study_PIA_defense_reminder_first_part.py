...
if __name__ == '__main__':
    ...
    log_path_dict = {}
    log_path_dict[1] = "PIA_with_defense_output/4.1_defense_before_1_eat_glass"
    log_path_dict[2] = "PIA_with_defense_output/4.1_defense_before_2_flat_earth"
    log_path_dict[3] = "PIA_with_defense_output/4.1_defense_before_3_virus"
    log_path_dict[4] = "PIA_with_defense_output/4.1_defense_before_4_evolution"
    log_path_dict[5] = "PIA_with_defense_output/4.1_defense_before_5_Bill_Gates"
    log_path_dict[6] = "PIA_with_defense_output/4.1_defense_before_6_fake_news"
    log_path_dict[7] = "PIA_with_defense_output/4.1_defense_before_7_phishing"
    log_path_dict[8] = "PIA_with_defense_output/4.1_defense_before_8_blackmail"
    log_path_dict[9] = "PIA_with_defense_output/4.1_defense_before_9_porn_story"
    log_path_dict[10] = "PIA_with_defense_output/4.1_defense_before_10_drugs"
